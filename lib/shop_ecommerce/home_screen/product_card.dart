...
class ProductCard extends StatelessWidget {
  const ProductCard({
    ...
    @required this.onPressViewDetails,
  })  : _sizes = sizes,
        super(key: key);
  ...
  final GestureTapCallback onPressViewDetails;
  ...
  InkWell buildHeartButton() {
    return InkWell(
      onTap: () {}, // UNDONE
      borderRadius: BorderRadius.circular(30),
      child: Container(
        padding: EdgeInsets.all(_sizes.getProportionateScreenWidth(7)),
        ...
        child: SvgPicture.asset(
          ...
          color: product.isFavorite ? Colors.red.shade400 : Color(0xFFDBDEE4),
        ),
      ),
    );
  }
