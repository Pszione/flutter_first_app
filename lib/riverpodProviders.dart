import 'package:flutter_first_app/mockDatabase.dart'; // simple_example
...
final counterController = StateNotifierProvider<CounterNotifier, dynamic>((ref) => CounterNotifier());
...
final counterAsyncController = StateNotifierProvider<CounterNotifierAsync, AsyncValue<int>>((ref) => CounterNotifierAsync(ref.read/*(databaseProvider)*/));
...
class CounterNotifierAsync extends StateNotifier<AsyncValue<int>>{
  ...
  void add() async{
    state = AsyncLoading(); // we are in a loading state until we get our response
